...
#define BLYNK_TEMPLATE_ID "TMPL3vRBivvMR"
#define BLYNK_TEMPLATE_NAME "Water Level Monitoring"
#define BLYNK_AUTH_TOKEN "VFVr2UAGDKKHPI9l389OGAZc6KKZATzU"
...
int emptyTankDistance = 30 ;  //Distance when tank is empty
int fullTankDistance =  3 ;  //Distance when tank is full (must be greater than 25cm)

//Set trigger value in percentage
int triggerPer =   30 ;  //alarm/pump will start when water level drop below triggerPer
